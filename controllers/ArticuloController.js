...
module.exports = {
    ...
    update: async(req, res, next) => {
        try {
            ...
            const reg = await models.Articulo.update({ categoriaId: req.body.categoria, codigo: req.body.codigo, nombre: req.body.nombre, descripcion: req.body.descripcion, precio_venta: req.body.precio_venta, stock: req.body.stock , urlIcono: req.body.urlIcono, urlImagen: req.body.urlImagen, descripcionCorta: req.body.descripcionCorta}, { where: { id: req.body.id } });
